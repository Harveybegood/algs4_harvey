...
/*
*   Triplicate. Given three lists of N names each, devise a linearithmic algorithm to determine if there is any name
*   common to all three lists, and if so, return the first such name.
*
* */
