...
/*
*   Priority queue with explicit linkedlists. Implement a priority queue using a heap-ordered binary tree, but use a triply
*   linked structure instead of an array. You will need three linkedlists per node: two to traverse down the tree and one to
