...
public class Ex19_1 {
    private static int localMinimumMatrix(int[][] matrix, int firstRow, int endRow, int firstColumn, int endColumn){
        if (firstRow == endRow && firstColumn == endColumn) return matrix[firstRow][firstRow];
        ...
        // check if minimum element is a local minimum, if not, then recurse;
        if (currentMinimumElementRow - 1 >= 0 && matrix[currentMinimumElementRow][currentMinimumElementColumn] >
                matrix[currentMinimumElementRow - 1][currentMinimumElementColumn]){
            // element above is smaller
            if (currentMinimumElementRow - 1 <= centerRow) endRow = centerRow;
            else firstRow = centerRow;
            if (currentMinimumElementColumn <= centerColumn) endColumn = centerColumn;
            else firstColumn = centerColumn;
            return localMinimumMatrix(matrix,firstRow,endRow,firstColumn,endColumn);
        }else if (currentMinimumElement + 1 < matrix.length && matrix[currentMinimumElementRow][currentMinimumElementColumn] >
                matrix[currentMinimumElementRow + 1][currentMinimumElementColumn]){
            ...
            return localMinimumMatrix(matrix,firstRow,endRow,firstColumn,endColumn);
        }else if (currentMinimumElementColumn - 1 >= 0 && matrix[currentMinimumElementRow][currentMinimumElementColumn] >
                matrix[currentMinimumElementRow][currentMinimumElementColumn - 1]){
            // element to the left is smaller
            if (currentMinimumElementRow <= centerRow) endRow = centerRow;
            else firstRow = centerRow;
            if (currentMinimumElementColumn - 1 <= centerColumn) endColumn = centerColumn;
            else firstColumn = centerColumn;
            return localMinimumMatrix(matrix,firstRow,endRow,firstColumn,endColumn);
        }else if (currentMinimumElementColumn + 1 < matrix[0].length && matrix[currentMinimumElementRow][currentMinimumElementColumn] >
                matrix[currentMinimumElementRow][currentMinimumElementColumn + 1]){
    ...
    public static void main(String[] args) {
        ...
        int matrix5[][] = {{5,90,3,10},
                           ...
                           {7,-1,-8,19},
                           {12,8,13,99}};
        int localMinimum1 = localMinimumMatrix(matrix1,0,matrix1.length-1,0,matrix1[0].length-1);
        int localMinimum2 = localMinimumMatrix(matrix2,0,matrix2.length-1,0,matrix2[0].length-1);
        int localMinimum3 = localMinimumMatrix(matrix3,0,matrix3.length-1,0,matrix3[0].length-1);
        int localMinimum4 = localMinimumMatrix(matrix4,0,matrix4.length-1,0,matrix4[0].length-1);
        int localMinimum5 = localMinimumMatrix(matrix5,0,matrix5.length-1,0,matrix5[0].length-1);
        StdOut.println("Local minimum matrix: " + localMinimum1);
        StdOut.println("Local minimum matrix: " + localMinimum2);
        StdOut.println("Local minimum matrix: " + localMinimum3);
        StdOut.println("Local minimum matrix: " + localMinimum4);
        StdOut.println("Local minimum matrix: " + localMinimum5);
    }
}
