...
/*
*   Modify BinarySearchST to maintain one array of Item objects that contain keys and values, rather than two parallel
*   arrays. Add a constructor that takes an array of Item values as argument and uses mergesort to sort the array.
*
* */
@SuppressWarnings("unchecked")
public class Ex12_ModifyBinarySearchST_version1<Key extends Comparable<Key>, Value> {
    ...
    private Item[] items;
    private int N;
   /* public Ex12_ModifyBinarySearchST_version1(int cap){
        items = new Ex12_ModifyBinarySearchST_version1.Item[cap];
    }*/
    public Ex12_ModifyBinarySearchST_version1(Item[] items){
        Merge.sort(items);
        this.items = items;
    }
    ...
    public static void main(String[] args) {
        Ex12_ModifyBinarySearchST_version1.Item[] items = new Ex12_ModifyBinarySearchST_version1.Item[5];
        Ex12_ModifyBinarySearchST_version1<Integer, String> modifyBinarySearchST = new Ex12_ModifyBinarySearchST_version1<>(items);
