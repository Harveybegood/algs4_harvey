...
/*
*   Catenable queues, stacks, or steques. Add an extra operation catenation that (destructively) concatenates two
*   queues, stacks or steques.
 *  Hints: use a circular linked list, maintaining a pointer to the last item.
*
*   Steque-- pop(), push(), enqueue().
*   queue, Chapter1_3_Bags_Queues_Stacks.stack, steque
*
* */
public class Ex47 {
